...
3. Click to enter the Volcano Ark Console.
...
- See details: Volcano Ark Pricing
...
- Solution:
  - Check if the API Key is copied correctly (complete string starting with `sk-`).
  - Confirm that the API Key has not been deleted or expired.
...
- Solution:
  - Check the model status in the Volcano Ark Console.
  - Confirm that the model is in "Running" status.
...
- Solution:
  ...
  - Confirm that the `api_base` configuration is correct.
  - If you are overseas, confirm that you can access Volcengine services.
  - Increase the timeout in the configuration.

## Getting Help

- Volcengine Documentation Center
- Volcano Ark API Documentation
- OpenViking GitHub Issues

## Related Documentation

- Configuration Guide - Complete configuration reference
- Quick Start - Start using OpenViking
